...
public class RenderHamRawMobile extends RenderFoodMobile<EntityHamRawMobile> {
    ...
    @Override
    public void renderBody(double bodyOffset, EntityHamRawMobile entity, double x, double y, double z, float currentYaw, float partialTicks) {
