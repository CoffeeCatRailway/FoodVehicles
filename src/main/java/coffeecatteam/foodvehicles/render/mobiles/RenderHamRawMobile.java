...
import coffeecatteam.foodvehicles.objects.entity.mobiles.EntityHamRawMobile;
...
public class RenderHamRawMobile extends RenderVehicle<EntityHamRawMobile> {

	public RenderHamRawMobile(RenderManager renderManager) {
		super(renderManager);
	...
	@Nullable
	@Override
	protected ResourceLocation getEntityTexture(EntityHamRawMobile entity) {
		return null;
	}

	@Override
	public void doRender(EntityHamRawMobile entity, double x, double y, double z, float currentYaw, float partialTicks) {
