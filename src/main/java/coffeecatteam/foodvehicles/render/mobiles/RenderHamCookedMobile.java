...
import coffeecatteam.foodvehicles.objects.entity.mobiles.EntityHamCookedMobile;
...
public class RenderHamCookedMobile extends RenderVehicle<EntityHamCookedMobile> {
	...
	@Nullable
	@Override
	protected ResourceLocation getEntityTexture(EntityHamCookedMobile entity) {
		return null;
	}

	@Override
	public void doRender(EntityHamCookedMobile entity, double x, double y, double z, float currentYaw, float partialTicks) {
