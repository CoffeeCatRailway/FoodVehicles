...
public class RenderGrilledCheeseMobile extends RenderVehicle<EntityGrilledCheeseMobile> {
	...
	@Nullable
	@Override
	protected ResourceLocation getEntityTexture(EntityGrilledCheeseMobile entity) {
		return null;
	}

	@Override
	public void doRender(EntityGrilledCheeseMobile entity, double x, double y, double z, float currentYaw, float partialTicks) {
